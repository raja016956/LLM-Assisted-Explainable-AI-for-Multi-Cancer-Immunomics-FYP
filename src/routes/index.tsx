...
import { Dna, Mail, Lock, ShieldCheck } from "lucide-react";
    ...
    <div className="grid min-h-screen w-full grid-cols-1 lg:grid-cols-2">
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-primary via-primary to-[oklch(0.35_0.16_260)] p-12 text-primary-foreground lg:flex lg:flex-col lg:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-white/70">Immunomics Platform</div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mt-4 text-sm text-white/80">
            Interpret tumor immune phenotypes with transparent SHAP explanations
            grounded in curated biomedical literature — across BRCA, LUAD, COAD,
            SKCM, and GBM cohorts.
          </p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-3 text-xs">
            {[
              ...
              <div key={s.v} className="rounded-lg border border-white/15 bg-white/5 p-3">
      ...
      <div className="flex items-center justify-center bg-background p-8">
        <div className="w-full max-w-sm">
          ...
          <button className="mt-8 flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-border bg-card text-sm font-medium text-foreground transition-colors hover:bg-muted">
            <GoogleIcon />
          ...
          >
            ...
            <button
              type="submit"
              className="h-11 w-full rounded-lg bg-primary text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90"
            >
              Sign in
            </button>
          </form>
